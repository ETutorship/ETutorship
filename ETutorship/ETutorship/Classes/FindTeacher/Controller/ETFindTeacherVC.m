...
@interface ETFindTeacherVC () <UITableViewDelegate, UITableViewDataSource, ETBannerViewDelegate>
...
@implementation ETFindTeacherVC
...
- (void)loadData
{
    self.dataArray = [NSMutableArray arrayWithObjects:@"找初中老师", @"找高中老师", nil];
